...
public class HospitalEntityRecorder implements DBWritable {
	...
	public HospitalEntityRecorder(String hospital_id, String hospital_name, String hospital_loc_code,
			String hospital_location, String hospital_website, String hospital_call) {
		super();
	...
	public String toString() {
		return hospital_id + "," + hospital_name + "," + hospital_loc_code + "," + hospital_location + ","
				+ hospital_website + "," + hospital_call;
	}
