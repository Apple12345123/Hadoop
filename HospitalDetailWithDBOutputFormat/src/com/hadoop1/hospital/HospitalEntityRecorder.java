...
public class HospitalEntityRecorder implements DBWritable {
	...
	public HospitalEntityRecorder(String hospital_id, String mon_start_time, String mon_end_time, String tue_start_time,
			String tue_end_time, String wed_start_time, String wed_end_time, String thu_start_time, String thu_end_time,
	...
	public String toString() {
		return hospital_id + "," + mon_start_time + "," + mon_end_time + "," + tue_start_time + "," + tue_end_time + ","
				+ wed_start_time + "," + wed_end_time + "," + thu_start_time + "," + thu_end_time + "," + fri_start_time
				+ "," + fri_end_time + "," + sat_start_time + "," + sat_end_time + "," + sun_start_time + ","
				+ sun_end_time + "," + sun_holiday + "," + lunchtime + "," + holiday;
	}
